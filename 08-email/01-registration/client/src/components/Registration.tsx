...
export default class Registration extends Component<any, IRegistrationState> {
  constructor(props) {
    super(props);
  ...
  onDisplayNameChanged: React.ChangeEventHandler<HTMLFormElement> = (event) => {
    this.setState({
      displayName: event.target.value,
    });
  };

  onEmailChanged: React.ChangeEventHandler<HTMLFormElement> = (event) => {
    this.setState({
      email: event.target.value,
    });
  };

  onPasswordChanged: React.ChangeEventHandler<HTMLFormElement> = (event) => {
    this.setState({
